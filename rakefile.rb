...
ROOT_NAMESPACE = "SimpleServer"
RESULTS_DIR = "build/test-reports"
BUILD_NUMBER_BASE = "0.1.0"
PRODUCT = ROOT_NAMESPACE
COPYRIGHT = 'Copyright Maanas Bukurri, Joshua Arnold 2011. All rights reserved.';
...
task :unit_tests do
  ...
  runner.executeTests ['SimpleServer.Tests']
end

task :release do
	copyOutputFiles "src/SimpleServer/bin/#{COMPILE_TARGET}", "SimpleServer*.{dll,pdb}", props[:archive]
